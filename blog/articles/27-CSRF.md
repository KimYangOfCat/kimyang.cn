---
title: "CSRF 攻击：解析、预防和 CSRF 令牌"
date: 2021-05-26
tags: [Web 安全, 前端]
categories: [🌏 翻译校对]
---

跨站请求伪造，也被称为 CSRF、Sea Surf 或者 XSRF。它是一种攻击方式，攻击者利用它诱骗受害者代表他们自己执行操作。受害者持有的权限级别决定了 CSRF 攻击的影响范围。这种攻击利用了一个事实：一旦用户通过网站服务的身份认证，网站就完全信任该用户（译者注：身份认证指 cookie）。<!-- more -->
...
![CSRF](https://picbed.kimyang.cn/202109050834005.png)
