...
![如何打造可被摇树优化的库](https://picbed.kimyang.cn/202109050832928.png)
...
网上有很多解释摇树优化和未引用代码移除的文章和资源。这里我们会集中讨论那些应用里中引用的库。当引用一个库的应用能够**成功地移除这个库中未被引用的部分**时，这个库才能被认为做到了摇树优化（tree shakeable）。
 ...
 [![一个可摇树优化的库的例子](https://picbed.kimyang.cn/202109050832922.png) 
...
![使用 ESM 格式的库的导出模块图](https://picbed.kimyang.cn/202111060227679.jpeg)
...
![使用 ESM 格式的库的导出模块图](https://picbed.kimyang.cn/202111060235702.jpeg)
...
![副作用优化下的模块图](https://picbed.kimyang.cn/202111060236300.jpeg)
...
![在使用 CJS 格式的依赖时，保留模块结构能够改善摇树优化效果](https://picbed.kimyang.cn/202111060239769.jpeg)
...
![代码分割导致摇树优化出现的问题](https://picbed.kimyang.cn/202111060242009.jpeg)
...
![保留模块树可以让 Webpack 独立地对分割的 chunk 进行摇树优化](https://picbed.kimyang.cn/202111060244091.jpeg)
 ...
 * 校对者：[Usualminds](https://github.com/Usualminds)、[Kim Yang](https://github.com/KimYangOfCat)